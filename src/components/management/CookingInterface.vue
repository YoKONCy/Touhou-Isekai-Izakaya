    ...
    <div class="cooking-container">
      ...
      <div class="pot-section">
          ...
          <div class="pot-body">
            ...
            <transition-group name="toss">
              ...
              >
                ...
                <div class="ingredient-timer-badge">{{ cookingTime - item.timeAdded }}s</div>
              </div>
            </transition-group>
          </div>
        ...
        <div class="finish-section">
          ...
          />
          <button class="finish-btn" :disabled="potIngredients.length === 0" @click="finishCooking">
            <Check class="w-5 h-5" />
            <span>完成料理</span>
          </button>
        </div>
      ...
      <div class="ingredients-section">
        ...
        <div class="request-hint" v-if="customerRequirement">
          ...
          <span class="text-sm text-gray-300"
            >顾客要求: <span class="text-white font-bold">{{ customerRequirement }}</span></span
          >
        </div>
