...
// 初始拉取
watch(
  [activeTab, lobbySubTab, serverUrl],
  ([tab, subTab, url]) => {
  ...
  try {
    ...
    if (success) {
      ...
      gameStore.setRoomInfo(
        roomIdInput.value,
        joinPasswordInput.value,
        selectedRoom?.name || roomIdInput.value
      );
  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          @click="handleClose"
          class="p-1 hover:bg-touhou-red/10 rounded-full text-izakaya-wood/50 hover:text-touhou-red transition-colors relative z-50"
        >
          <X class="w-5 h-5" />
        </button>
      </div>
      ...
      <div class="flex-1 overflow-hidden flex relative z-10">
          ...
          <div class="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar relative">
            ...
            <div class="space-y-4 text-sm text-izakaya-wood/80 leading-relaxed font-serif-display">
              <section class="space-y-2">
                ...
                <p>
                  官方中继服务器（Relay Server）仅负责实时数据转发，<span
                    class="text-touhou-red font-bold"
                    >不存储</span
                  >
                  任何聊天内容、游戏指令或存档数据。所有数据在内存中即发即焚。
                </p>
              </section>
              ...
              <section class="space-y-2">
                ...
                <p>
                  建议为房间设置密码。设置密码后，系统将启用 AES-GCM
                  端到端加密，您的通信内容在经过服务器时为密文，除房间成员外无人可解密。
                </p>
              </section>
              ...
              <section class="space-y-2">
                ...
                <p>
                  用户需自觉遵守当地法律法规。严禁利用本联机功能传播任何政治敏感、淫秽色情、暴力恐怖或侮辱他人的信息。由于技术上无法解密私密通话，您需对自己的言论负全部法律责任。
                </p>
              </section>
              ...
              <section class="space-y-2">
                ...
                <p>
                  本服务为非盈利性质的技术交流设施，不保证服务的绝对稳定性。因网络波动、服务器维护或不可抗力导致的数据丢失或连接中断，开发者不承担相关责任。
                </p>
              </section>
        ...
        >
          <button
            v-for="nav in [
              ...
              { id: 'profile', icon: User, label: '人设' },
              {
                ...
                icon: Users,
                label: '房间',
                disabled: !gameStore.multiplayer.isMultiplayer
              },
              { id: 'settings', icon: Settings, label: '设置' }
            ]"
            :key="nav.id"
            @click="
              !nav.disabled && (activeTab = nav.id as any);
              audioManager.playSoftClick();
            "
            ...
            :class="[
              activeTab === nav.id
                ? 'bg-touhou-red text-white shadow-lg'
                : 'text-izakaya-wood/40 hover:bg-white hover:text-izakaya-wood',
          ...
          >
            ...
            <div
              v-if="nav.id === 'room' && gameStore.multiplayer.isMultiplayer"
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-white/30">
          ...
          >
            ...
            <div class="p-4 border-b border-izakaya-wood/10 bg-white/40">
              <div class="flex items-center justify-between mb-3">
                ...
                <div class="flex bg-izakaya-wood/5 p-1 rounded-lg border border-izakaya-wood/10">
                  <button
                    ...
                    :class="
                      isOfficialServer
                        ? 'bg-white text-touhou-red shadow-sm'
              ...
              <div
                v-if="isOfficialServer || isCustomServerConnected"
              ...
              >
                <span v-if="!isOfficialServer" class="text-[10px] font-mono text-green-700">{{
                  serverUrl
                }}</span>
            ...
            >
              <div class="flex gap-2 mb-4 bg-izakaya-wood/5 p-1 rounded-xl">
                <button
                  ...
                  :class="
                    lobbySubTab === 'join'
                      ? 'bg-white text-izakaya-wood shadow-sm'
                      : 'text-izakaya-wood/40'
                  "
                >
                  浏览大厅
              ...
              >
                <div class="relative">
                  <Search
                    class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-izakaya-wood/30"
                  />
                  <input
                    type="text"
                  ...
                  >
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex items-center gap-4">
                        ...
                        <div class="text-[10px] text-izakaya-wood/50 font-bold">
                          房主: {{ room.host }}
                        </div>
                      </div>
                      <button
                ...
                <div
                  class="p-3 bg-izakaya-wood/5 rounded-xl border border-dashed border-izakaya-wood/20 flex flex-col items-center justify-center gap-2"
                >
                  ...
                  <div class="flex flex-col gap-2 w-full">
                    <div class="flex gap-2 w-full">
                      <input
                        ...
                        class="flex-1 px-3 py-1.5 bg-white border border-izakaya-wood/10 rounded-lg text-[10px] outline-none"
                      />
                      <input
                    ...
                    <button
                      ...
                      class="w-full py-1.5 bg-izakaya-wood text-white rounded-lg text-[10px] font-bold hover:bg-izakaya-wood/90 transition-all"
                    >
                      直连加入
                    </button>
                  </div>
                ...
                <div class="p-4 bg-white border border-izakaya-wood/10 rounded-2xl space-y-4">
                  <div class="space-y-2">
                    ...
                    <input
                      ...
                      class="w-full px-4 py-2 bg-izakaya-wood/5 border border-izakaya-wood/10 rounded-xl text-xs outline-none focus:border-touhou-red transition-all"
                    />
                  </div>
                  <div class="space-y-2">
                    ...
                    <div class="relative">
                      ...
                      <input
                        ...
                        type="password"
                        placeholder="留空则公开"
                        class="w-full pl-10 pr-4 py-2 bg-izakaya-wood/5 border border-izakaya-wood/10 rounded-xl text-xs outline-none focus:border-touhou-red transition-all"
                      />
                    </div>
                  </div>
                  <div
                    class="flex items-center gap-3 p-3 bg-yellow-50 border border-yellow-100 rounded-xl"
                  >
                    <Info class="w-4 h-4 text-yellow-600 flex-shrink-0" />
                    <p class="text-[10px] text-yellow-700 leading-relaxed font-medium">
                      创建房间后，您将作为 Host 承担所有计算与存储任务，请保持游戏运行。
                    </p>
                  </div>
                </div>
                <button
            ...
            >
              ...
              <div class="absolute inset-0 pointer-events-none opacity-5">
                ...
                ></div>
                <div
                  class="absolute bottom-10 right-10 w-40 h-40 bg-blue-500 rounded-full filter blur-3xl"
                ></div>
              </div>
              ...
              <div class="mb-6 relative z-10">
                ...
                >
                  <div
                    class="absolute -right-4 -top-4 opacity-10 transform rotate-12 transition-transform group-hover:scale-110 group-hover:rotate-6 duration-500"
                  >
                  ...
                  <div
                    class="flex items-center gap-2 bg-green-50/50 backdrop-blur-sm p-3 rounded-xl border border-green-100/50 shadow-inner group-hover:bg-white/90 transition-colors"
                  >
                    <div class="flex-1">
                      <div
                        class="text-[10px] text-green-600/50 uppercase font-bold tracking-tighter mb-0.5"
                      >
                        ROOM: {{ gameStore.multiplayer.roomName || 'UNNAMED' }}
                      </div>
                      <code class="text-xl font-mono font-bold text-green-800 tracking-wider">{{
                        gameStore.multiplayer.roomId
                      }}</code>
                    </div>
                    <button
                      @click="copyRoomId"
                      class="p-2.5 bg-white text-green-600 rounded-lg hover:text-green-700 hover:shadow-md transition-all active:scale-95 border border-green-100"
                      title="复制 ID"
                    >
                      <Copy class="w-5 h-5" />
                    </button>
              ...
              <div class="grid grid-cols-2 gap-4 mb-6 relative z-10">
                ...
                >
                  ...
                  <div class="text-2xl font-bold text-izakaya-wood font-display">
                    {{ gameStore.multiplayer.players.length
                    }}<span class="text-sm text-izakaya-wood/30 ml-1">/ 6</span>
                  </div>
                </div>
                <div
                  class="p-4 bg-white/60 border border-izakaya-wood/10 rounded-2xl shadow-sm hover:shadow-md transition-shadow"
              ...
              <div
                class="flex-1 flex flex-col items-center justify-center text-center p-6 bg-white/40 rounded-3xl border border-dashed border-izakaya-wood/10 relative z-10"
              >
                <div
                  class="w-20 h-20 bg-gradient-to-br from-touhou-red/10 to-transparent rounded-full flex items-center justify-center mb-4 shadow-sm animate-pulse"
                >
                  <div
                    class="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md"
                  >
                ...
                <p class="text-xs text-izakaya-wood/50 max-w-[240px] leading-relaxed">
                  您已成功加入多人联机网络。点击左侧侧边栏的
                  <span class="font-bold text-touhou-red">“房间”</span>
                  图标，查看所有成员状态并进行管理。
                </p>
              </div>
            </div>
          ...
          >
            <div class="mb-6">
              ...
              <p class="text-xs text-izakaya-wood/50 mt-1">
                作为客机加入他人房间时，其他玩家将看到这些信息。
              </p>
            </div>
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar pr-1 space-y-6">
              ...
              >
                ...
                <div class="relative z-10 flex gap-4">
                  <div
                    class="w-16 h-16 bg-touhou-red/10 rounded-full flex items-center justify-center text-touhou-red text-2xl font-bold border-2 border-white shadow-md"
                  >
                    {{ playerSetup.name ? playerSetup.name.charAt(0) : '?' }}
                  </div>
                  <div class="flex-1 space-y-1">
                    <div class="flex items-center gap-2">
                      <h4 class="text-lg font-bold text-izakaya-wood">
                        {{ playerSetup.name || '未设定昵称' }}
                      </h4>
                      <span
                        class="px-2 py-0.5 bg-izakaya-wood/5 rounded text-[10px] font-bold text-izakaya-wood/60"
                      >
                        Rank: {{ playerSetup.power || 'E' }}
                      </span>
                    </div>
                    <p class="text-sm text-touhou-red font-bold">
                      {{ playerSetup.identity || '未设定身份' }}
                    </p>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    ...
                    <h4 class="text-xs font-bold text-izakaya-wood uppercase tracking-wider">
                      身份识别秘钥 (Identity Key)
                    </h4>
                  </div>
                  <HelpCircle
                    class="w-4 h-4 text-izakaya-wood/30 cursor-help"
                    title="用于在不同浏览器或设备间同步您的玩家身份"
                  />
                </div>
                ...
                <div v-if="!isEditingKey" class="flex items-center gap-2">
                  <div
                    class="flex-1 px-4 py-2 bg-white border border-izakaya-wood/10 rounded-xl font-mono text-xs text-izakaya-wood/70 truncate shadow-inner"
                  >
                    {{ identityKey }}
                  </div>
                  <button
                    @click="handleCopyKey"
                    class="p-2 bg-white text-izakaya-wood/60 rounded-xl hover:text-touhou-red border border-izakaya-wood/10 shadow-sm transition-all active:scale-95"
                    title="复制秘钥"
                  >
                    <Copy class="w-4 h-4" />
                  </button>
                  <button
                    @click="handleStartEditKey"
                    class="px-3 py-2 bg-white text-izakaya-wood/60 rounded-xl hover:text-touhou-red border border-izakaya-wood/10 shadow-sm text-[10px] font-bold transition-all active:scale-95"
                  >
                    修改/导入
                  </button>
                </div>
                ...
                <div v-else class="space-y-3">
                  ...
                  <div class="flex gap-2">
                    <button
                      @click="handleSaveKey"
                      class="flex-1 py-2 bg-touhou-red text-white rounded-xl text-[10px] font-bold shadow-md shadow-touhou-red/20 active:scale-95 transition-all"
                    >
                      保存并应用
                    </button>
                    <button
                      @click="isEditingKey = false"
                      class="px-4 py-2 bg-white text-izakaya-wood/40 rounded-xl text-[10px] font-bold border border-izakaya-wood/10 active:scale-95 transition-all"
                    >
                      取消
                    </button>
                  </div>
          ...
          >
            <div class="flex items-center justify-between mb-6">
              ...
              <div
                class="flex items-center gap-2 px-3 py-1 bg-green-50 text-green-600 rounded-full border border-green-100"
              >
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar space-y-3 pr-1">
              <div
                v-for="player in gameStore.multiplayer.players"
                :key="player.id"
              ...
              >
                <div class="relative">
                  <div
                    class="w-12 h-12 rounded-full bg-touhou-red/10 border border-touhou-red/20 flex items-center justify-center text-touhou-red font-bold text-lg shadow-inner group-hover:bg-touhou-red group-hover:text-white transition-all"
                  >
                    {{ player.name.charAt(0) }}
                  </div>
                  <div
                    v-if="player.isHost"
                    class="absolute -bottom-1 -right-1 bg-yellow-400 text-white rounded-full p-1 border-2 border-white shadow-sm"
                    title="房主"
                  >
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-1">
                    <div class="text-base font-bold text-izakaya-wood truncate">
                      {{ player.name }}
                    </div>
                    <div
                      v-if="player.isMe"
                      class="px-2 py-0.5 bg-blue-100 text-blue-600 text-[10px] rounded-full font-bold uppercase tracking-tighter"
                    >
                      本人
                    </div>
                  </div>
                  <div class="text-xs text-izakaya-wood/50 truncate flex items-center gap-2">
                    <span
                      class="inline-block w-2 h-2 rounded-full bg-green-500 shadow-[0_0_5px_rgba(34,197,94,0.5)]"
                    ></span>
                    {{ player.identity }}
                  </div>
                </div>
                ...
                <div class="flex flex-col items-end gap-2">
                  <div
                    v-if="player.isHost"
                    class="px-2 py-1 bg-touhou-red/5 text-touhou-red text-[10px] rounded border border-touhou-red/10 font-bold uppercase tracking-widest"
                  >
                    ROOM HOST
                  </div>
                  <div
                    v-else
                    class="px-2 py-1 bg-izakaya-wood/5 text-izakaya-wood/40 text-[10px] rounded border border-izakaya-wood/10 font-bold uppercase tracking-widest"
                  >
                    GUEST
                  </div>
                  <div
                    v-if="gameStore.multiplayer.isHost && !player.isMe"
                    class="opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <button class="text-[10px] font-bold text-red-400 hover:text-red-600">
                      移出房间
                    </button>
                  </div>
                </div>
          ...
          >
            ...
            <div class="space-y-6">
              <div class="p-4 bg-white border border-izakaya-wood/10 rounded-2xl space-y-4">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <div class="text-[10px] text-izakaya-wood/40 font-medium">
                      消息在本地加密，服务器无法解密剧情内容
                    </div>
                  </div>
                  <div class="w-10 h-5 bg-green-500 rounded-full relative shadow-inner">
                    <div
                      class="absolute right-1 top-1 w-3 h-3 bg-white rounded-full shadow-sm"
                    ></div>
                  </div>
                </div>
                ...
                <div class="border-t border-izakaya-wood/5 pt-4 flex items-center justify-between">
                  ...
                  <select
                    class="bg-izakaya-wood/5 border border-izakaya-wood/10 rounded-lg px-3 py-1 text-xs outline-none"
                  >
              ...
              <div
                class="p-4 bg-izakaya-wood/5 border border-izakaya-wood/10 rounded-2xl flex items-center gap-4"
              >
                <div
                  class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-touhou-red shadow-sm"
                >
                  <Server class="w-6 h-6" />
                </div>
                <div>
                  <div class="text-sm font-bold text-izakaya-wood">分发器版本 (Go Relay)</div>
                  <div class="text-[10px] text-izakaya-wood/40 font-mono uppercase font-bold">
                    v1.0.4-stable (E2EE Enabled)
                  </div>
                </div>
              </div>
            </div>
