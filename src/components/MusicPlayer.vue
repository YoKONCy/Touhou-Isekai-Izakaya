  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          <div class="flex gap-2">
            <button
              @click="
                store.mode =
                  store.mode === 'loop' ? 'random' : store.mode === 'random' ? 'single' : 'loop'
              "
            ...
            <button @click.stop="showSettings = false" class="hover:text-touhou-red">
              <X class="w-4 h-4" />
            </button>
          </div>
        </div>
        ...
        <div class="p-3 border-b border-izakaya-wood/10 bg-white/50">
          <div class="flex gap-2 mb-2 text-xs">
            <button
              ...
              :class="
                newTrackType === 'custom'
                  ? 'bg-touhou-red text-white border-touhou-red'
                  : 'border-izakaya-wood/30 hover:bg-izakaya-wood/10'
              "
            >
              自定义链接
            </button>
          ...
          <div class="flex gap-2">
            ...
            <button
              ...
              class="p-1 bg-izakaya-wood text-white rounded hover:bg-touhou-red transition-colors"
            >
              <Plus class="w-4 h-4" />
            </button>
          </div>
        ...
        <div class="max-h-60 overflow-y-auto p-1 custom-scrollbar">
          ...
          >
            <div
              class="w-6 h-6 flex items-center justify-center rounded-full bg-izakaya-wood/10 text-izakaya-wood/50 text-xs font-mono"
            >
              <span v-if="store.currentIndex === index && store.isPlaying" class="animate-pulse"
                >♫</span
              >
            ...
            <div class="flex-1 min-w-0">
              <div
                ...
                :class="{ 'text-touhou-red': store.currentIndex === index }"
              >
                {{ track.title }}
              </div>
          ...
          <div
            ...
            class="text-center py-4 text-xs text-izakaya-wood/40"
          >
            暂无曲目
          </div>
        </div>
    ...
    >
      ...
      <div
        ...
        :class="
          isExpanded
            ? 'w-full h-8 px-2 border-b border-izakaya-wood/10'
            : 'absolute left-0 top-0 bottom-0 w-4 justify-center'
        "
      >
        ...
        >
          <ChevronDown
            class="w-4 h-4 text-izakaya-wood/50 group-hover:text-touhou-red transition-transform duration-300"
          />
        </button>
      </div>
      ...
      >
        ...
        <div v-if="!isExpanded" class="flex items-center gap-2 relative z-10 pl-4">
          <button
            @click="store.prev"
            class="p-1 text-izakaya-wood hover:text-touhou-red transition-colors"
          >
          ...
          <button
            @click="toggleExpand"
            class="p-1 text-izakaya-wood/60 hover:text-touhou-red transition-colors"
          >
        ...
        <div v-else class="relative z-10 p-3 w-full">
          ...
          <div v-if="store.currentTrack?.type !== 'iframe'">
            ...
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-center gap-3 overflow-hidden">
                <div
                  class="w-10 h-10 rounded-md bg-izakaya-wood/10 flex items-center justify-center border border-izakaya-wood/10 shrink-0"
                >
                  <Music class="w-5 h-5 text-izakaya-wood/40" />
                </div>
                <div class="min-w-0">
                  <div class="text-sm font-bold truncate">
                    {{ store.currentTrack?.title || '未播放' }}
                  </div>
                  <div class="text-xs text-izakaya-wood/60 truncate">
              ...
              <div class="flex gap-1">
                <button
                  ...
                  class="p-1.5 text-izakaya-wood/60 hover:bg-izakaya-wood/10 rounded-full transition-colors"
                >
            ...
            <div class="flex items-center justify-between">
              <button
                @click="store.prev"
                class="p-2 text-izakaya-wood hover:text-touhou-red transition-colors"
              >
                <SkipBack class="w-4 h-4" />
              </button>
          ...
          >
            <div
              class="flex items-center justify-between px-2 py-1 bg-izakaya-wood/5 border-b border-izakaya-wood/10"
            >
              <span class="text-xs font-bold text-izakaya-wood/70 truncate px-1">{{
                store.currentTrack?.title
              }}</span>
              <div class="flex gap-1">
                <button
                  @click.stop="showSettings = !showSettings"
                  class="p-1 text-izakaya-wood/60 hover:bg-izakaya-wood/10 rounded"
                >
            ...
            ></iframe>
            <div
              class="flex items-center justify-between px-3 py-1 bg-izakaya-wood/5 border-t border-izakaya-wood/10"
            >
              <button
                @click="store.prev"
                class="p-1 text-izakaya-wood hover:text-touhou-red transition-colors"
