  ...
  >
    ...
    >
      ...
      <div class="relative z-10 p-8 text-center">
        ...
        <div
          class="mb-8 p-4 bg-stone-200/50 dark:bg-stone-800/50 rounded-lg border border-izakaya-wood/20 backdrop-blur-sm"
        >
          <p class="text-izakaya-wood dark:text-stone-300 mb-2 font-serif text-lg">遭遇敌人</p>
      ...
      ></div>
      <div
        class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-touhou-red to-transparent opacity-50"
      ></div>
    </div>
  </div>
</template>
