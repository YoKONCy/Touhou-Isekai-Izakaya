...
const locations = ref<LocationInfo[]>([
  {
    ...
    y: 74.6,
    type: 'temple',
    description: '命莲寺位于人间之里正南方的某处空地中，是由僧侣圣白莲创建的佛教寺庙。这里体现了圣白莲“佛法面前，众生平等”的理念，是人类与妖怪可以共同参拜、共同修行的独特场所。',
    characters: ['圣白莲', '寅丸星', '村纱水蜜', '娜兹玲', '封兽鵺', '云居一轮', '秦心', '多多良小伞', '幽谷响子'],
    subLocations: ['命莲寺大殿', '命莲寺墓地', '梦殿大祀庙'],
    subLocationDetails: {
      '命莲寺大殿': '庄严神圣的大殿，是僧侣们修行与诵经的核心场所。秦心与娜兹玲常在此研习佛法，空气中弥漫着淡淡的檀香味，能洗涤心灵的尘埃。',
      '命莲寺墓地': '位于寺庙后方的宁静墓园，虽然环境幽静，却时常能见到多多良小伞试图惊吓路人的身影。这里也是通往神秘梦殿大祀庙的必经之地。',
      '梦殿大祀庙': '曾深埋于地下的古老陵墓，现已通过圣人的伟力接入仙界。整座建筑被晶莹剔透的莲花池环绕，散发着超凡脱俗的仙气，是丰聪耳神子与其追随者的居所。'
    }
  },
  {
    id: 'misty-lake',
    ...
    y: 40.6,
    type: 'lake',
    description: '雾之湖是位于妖怪之山山脚下的神秘核心湖泊，因正午前后升起的浓雾而得名。这里栖息着大量妖精和体型巨大的鱼类，是幻想乡中景色优美但又充满未知危险的区域。',
    characters: ['琪露诺', '大妖精', '露米娅', '若鹭姬', '俊达萌'],
    subLocations: ['红魔馆', '雾之湖钓台', '春之小径'],
    subLocationDetails: {
      '红魔馆': '屹立于湖畔的深红洋馆，其哥特式的塔楼在浓雾中若隐若现。作为吸血鬼领主的领地，这里散发着令人敬畏的威压，是湖区最醒目的地标。',
      '雾之湖钓台': '由垂钓爱好者们搭建的木质平台，虽然简陋，却是观察湖中幻之鱼类的绝佳位置。有时也能见到若鹭姬在附近水域悄悄探头。',
      '春之小径': '一条被繁花簇拥的幽静小路，连接着湖泊与魔法森林。微风拂过时，落英缤纷，步行其中仿佛能忘却世俗的烦恼。'
    },
    collabCharacters: ['俊达萌'],
    collabCharacterDetails: {
      '俊达萌': '穿越而来的异世界虚拟歌手，以“毛豆妖精”的形态实体化。现作为红魔馆的临时外勤女仆，虽然运气极差且天然呆，但总能凭乐观心态迅速复原。'
    }
  },
  {
    id: 'human-village',
    ...
    y: 49.9,
    type: 'village',
    description: '位于幻想乡中心区域的人类聚居地，是人类文明、经济与文化的核心。这里有着传统的建筑风格，部分不危险的妖怪也会在此与人类共存，每个月7号的集市日尤为热闹。',
    characters: ['上白泽慧音', '稗田阿求', '本居小铃', '奥野田美宵', '铃瑚', '清兰', '冴月麟', '朱鹭子', '雏森', '月永爱', '菲娅'],
    subLocations: ['龙神广场', '观光缆车', '鲵吞亭', '寺子屋', '稗田邸', '铃奈庵'],
    subLocationDetails: {
      '龙神广场': '村落最繁华的中心地带，矗立着巨大的龙神石像。这里商铺林立，是居民们交换情报与日常社交的核心。',
      '观光缆车': '现代技术与魔法结合的产物，可从村里直达妖怪之山。透过车窗可以俯瞰整个人间之里的全景，是极佳的观光项目。',
      '鲵吞亭': '一家充满人情味的老字号酒馆。在奥野田美宵的打理下，无论是人类还是微服出巡的妖怪，都能在这里找到慰藉心灵的美酒与佳肴。',
      '寺子屋': '书声琅琅的学堂，上白泽慧音在此倾注心血教导孩子们。这里不仅是知识的殿堂，也是传承幻想乡历史的重要场所。',
      '稗田邸': '历史悠久的稗田家宅邸，保存着幻想乡最完整的文献记录。稗田阿求在此代代编撰《幻想乡缘起》，记录着这片土地的点点滴滴。',
      '铃奈庵': '藏书丰富的租书屋，本居小铃对这里的每一本书都如数家珍。除了普通的读物，这里偶尔也会出现一些蕴含神奇力量的“妖魔本”。'
    },
    collabCharacters: ['雏森', '月永爱', '菲娅'],
    collabCharacterDetails: {
      '雏森': '在寺子屋打杂的半人半妖少女，性格要强且心思缜密。为了筹集母亲的医药费而努力工作，在干练的外表下隐藏着渴望关爱的内心。',
      '月永爱': '来自外界的见习魔术师，总是元气满满。她擅长塔罗占卜，梦想在人间之里举办大型魔术秀，自称能感知到不凡的命运轨迹。',
  ...
  },
  {
    ...
    y: 39.8,
    type: 'shrine',
    description: '坐落于幻想乡极东边境、博丽大结界之上的神社。它是维持大结界的核心，也是灵梦的住处。虽然参拜客稀少，但由于巫女的宽容态度，这里成为了妖怪们经常聚集的社交场所。',
    characters: ['博丽灵梦', '伊吹萃香', '比那名居天子', '针妙丸'],
    subLocations: ['本殿', '赛钱箱', '庭院', '间歇泉', '守矢神社分社'],
    subLocationDetails: {
      '本殿': '古朴而宁静的建筑，博丽巫女日常生活与修行的核心。尽管装饰简单，却透着一股不容侵犯的威严与平和。',
      '赛钱箱': '神社庭院中那个略显寂寞的木箱。虽然它总是在等待着香客的慷慨，但更多时候只是作为灵梦叹息时的背景。',
      '庭院': '视野开阔的空地，是举办宴会、清扫落叶以及偶尔进行弹幕对决的舞台。从这里可以远眺幻想乡的群山。',
      '间歇泉': '伴随着巨大的轰鸣声从地下喷薄而出的泉眼。水汽中夹杂着地底的炙热气息，是通往旧地狱世界的秘密门户。',
      '守矢神社分社': '两家神社友好竞争与合作的象征。这座分社不仅分流了信仰，也成为了博丽神社与妖怪之山之间便捷的沟通枢纽。'
    }
  },
  {
    id: 'sunflower-field',
    ...
    y: 76.7,
    type: 'forest',
    description: '遍布向日葵的广阔草原，由风见幽香管理。这里寄宿着数众多的妖精，夏季夜晚甚至会举办盛大的演唱会。花田深处还隐藏着生长有毒铃兰花的无名之丘。',
    characters: ['风见幽香', '梅蒂欣', '莉莉霍瓦特'],
    subLocations: ['风见幽香的住所', '无名之丘'],
    subLocationDetails: {
      '风见幽香的住所': '掩映在万花丛中的精致木屋，处处透着主人对植物的热爱。若非主人的威名在外，这里本该是幻想乡最迷人的度假胜地。',
      '无名之丘': '一片被紫色铃兰覆盖的寂静山丘。虽然美得凄凉，但空气中弥漫的剧毒花粉提醒着外人：这里是属于人偶梅蒂欣的领地。'
    }
  },
  {
    id: 'magic-forest',
    ...
    y: 61.4,
    type: 'forest',
    description: '幻想乡中最大、湿度最高的原始森林，充斥着能产生幻觉的瘴气。这种环境虽然危险，却有助于魔法使提升魔力，因此吸引了魔理沙和爱丽丝等魔法使在此定居。',
    characters: ['雾雨魔理沙', '爱丽丝', '露米娅', '莉格露', '森近霖之助'],
    subLocations: ['雾雨魔法店', '香霖堂', '爱丽丝的宅邸', '无缘冢'],
    subLocationDetails: {
      '雾雨魔法店': '虽然门口挂着营业的招牌，但推门进去多半只能看到堆积如山的奇妙杂物。这里是魔理沙研制新型弹幕与存放“借来”物品的基地。',
      '香霖堂': '位于森林边缘的一座静谧古董店。店主森近霖之助收集了许多来自外界的奇妙物品，每一件器物背后都隐藏着不为人知的故事。',
      '爱丽丝的宅邸': '森林中一座精致的西式洋馆。屋内摆满了各式各样栩栩如生的人偶，在爱丽丝精妙的丝线操控下，这些家务人偶能让屋子始终保持一尘不染。',
      '无缘冢': '幻想乡中最为阴郁的地带之一，是结界薄弱、彼岸花盛开的地方。这里埋葬着无数无名的遗骨，空气中弥漫着淡淡的哀愁。'
    }
  },
  {
    id: 'bamboo-forest',
    ...
    y: 79.6,
    type: 'forest',
    description: '位于人间之里东南侧的广阔竹林，以极易迷路而闻名。林中常年弥漫着雾气，竹子生长极快且形状诡异。深处隐藏着古老的宅邸“永远亭”，是月之民隐居的地方。',
    characters: ['蓬莱山辉夜', '八意永琳', '铃仙', '因幡帝', '藤原妹红', '米斯蒂娅'],
    subLocations: ['永远亭', '夜雀食堂', '藤原小屋'],
    subLocationDetails: {
      '永远亭': '隐匿在竹林深处的辉煌建筑，充满了超越时代的古老气息。这里是月之民的避风港，内部的空间感被永琳的术法扭曲，常人难窥其全貌。',
      '夜雀食堂': '竹林深处唯一的暖光。米斯蒂娅在此支起摊位，为迷途的行人或深夜出没的妖怪提供热气腾腾的小吃，歌声伴随着炭火味在竹林间回荡。',
      '藤原小屋': '藤原妹红在竹林中的简朴居所。虽然简陋，却承载着这位不死之人漫长岁月中难得的片刻安宁。'
    }
  },
  {
    id: 'shimmy-castle',
    ...
    y: 26,
    type: 'castle',
    description: '悬浮在幻想乡上空的倒悬城池，城内展现出日式传统美景。它是利用万宝槌魔力建起的奇迹建筑，虽曾因魔力逆转而被幽闭，如今仍是幻想乡天空中一道独特的风景。',
    characters: ['少名针妙丸', '鬼人正邪', '今泉影狼', '崛川雷鼓'],
    subLocations: ['逆针阁'],
    subLocationDetails: {
      '逆针阁': '辉针城中最核心的倒悬大厅。精美的浮世绘与传统的日式结构在这里被重力反转，展现出一种荒诞而华丽的视觉冲击力。'
    }
  },
  {
    id: 'sdm',
    ...
    y: 44.7,
    type: 'mansion',
    description: '坐落于雾之湖北岸的哥特式洋馆，散发着深红色的妖气。这座由吸血鬼蕾米莉亚从外界整体迁入的奢华居所，拥有幻想乡最大的地下图书馆，生活风格华丽且充满了西洋气息。',
    characters: ['蕾米莉亚', '芙兰朵露', '十六夜咲夜', '帕秋莉', '红美铃', '小恶魔', '俊达萌'],
    subLocations: ['大图书馆', '地下室', '大厅', '俊达萌'],
    subLocationDetails: {
      '大图书馆': '由帕秋莉管理的巨大书库，空气中弥漫着古老羊皮纸与魔法药水的味道。这里收藏了无数禁忌的魔导书，是魔法使梦寐以求的圣地。',
      '地下室': '位于馆内最深处的阴冷空间，长期以来一直是二小姐芙兰朵露的活动区域。复杂的防御魔法和压抑的气氛让人不寒而栗。',
      '大厅': '红魔馆的门面所在，铺着华贵的深红地毯。门卫红美铃常在此尽职（或是在打瞌睡）地守卫着这座洋馆的威严。',
      '俊达萌': '穿越而来的异世界虚拟歌手，以“毛豆妖精”的形态实体化。现作为红魔馆的临时外勤女仆，主要负责雾之湖周边的采集与传讯，虽然笨拙但非常勤快。'
    }
  },
  {
    id: 'youkai-mountain',
    ...
    y: 22.3,
    type: 'mountain',
    description: '幻想乡的科技与文明中心，居住着天狗和河童等高度发达的妖怪社会。山中拥有工厂、报社等现代化设施，管理极其严格。山顶的风神之湖旁坐落着从外界迁入的守矢神社。',
    characters: ['射命丸文', '犬走椛', '河城荷取', '姬海棠果', '键山雏', '东风谷早苗', '八坂神奈子', '洩矢诹访子'],
    subLocations: [
      '守矢神社', '九天瀑布', '河童机械工厂', '虹龙洞', '月虹市场', 
      '妖怪的树海', '黑暗风穴', '大蛤蟆之池', '秘天崖', '伪天棚', 
      '中有之道', '三途之川', '玄云海', '媒体中心'
    ],
    subLocationDetails: {
      '守矢神社': '矗立在山顶云端的神社，供奉着从外界迁入的强大神明。这里不仅是信仰的源泉，也通过先进的科学技术影响着整座大山的运作。',
      '九天瀑布': '从绝壁上奔流而下的壮丽瀑布，水汽氤氲中常能见到白狼天狗巡逻队矫健的身影，是妖怪之山的天然防线。',
      '河童机械工厂': '充满了齿轮啮合声与蒸汽轰鸣的地下工坊。河童们在这里发挥惊人的创造力，制造出各种超越幻想乡常识的精密机械. ',
      '虹龙洞': '由人工开凿、蜿蜒曲折的矿坑。洞壁上镶嵌着色彩斑斓的龙珠，在黑暗中散发出迷人的幽光，吸引着无数寻宝者。',
      '月虹市场': '位于山腰处的繁华集市，是能力卡牌交易的核心场所。每当市场开启，来自幻想乡各地的妖怪都会在此汇聚，热闹非凡。',
      '妖怪的树海': '山脚下一片茂密而幽深的原始森林。这里的树木高耸入云，遮天蔽日，是许多隐居妖怪的天然庇护所。',
      '黑暗风穴': '一个通向地底世界的神秘入口。洞口不断吹出冰冷刺骨的寒风，仿佛能将闯入者的灵魂冻结。',
      '大蛤蟆之池': '半山腰的一处清幽水潭，传说中是进行某种神圣仪式的必经之地。平静的水面下似乎潜伏着古老而强大的气息。',
      '秘天崖': '怪石嶙峋的险峻山崖，是山童们建立聚居地的地方。这里的岩石形态各异，仿佛是自然界鬼斧神工的艺术品. ',
      '伪天棚': '位于高海拔地区的开阔草甸，视野极佳。在这里开设的地下赌场是某些妖怪发泄精力的秘密场所。',
      '中有之道': '一条引导生灵走向彼岸的长廊。两侧开满了彼岸花，走在这里的人会感到一种时空错位的虚幻感。',
      '三途之川': '生死两界的分水岭。河面上常年雾气昭昭，唯有死神的小船在平静的水面上划出一道道涟漪。',
      '玄云海': '层峦叠嶂之上的金色云海，是通往至高天界的必经之路。金色的光芒穿透云层，呈现出一种神圣不可侵犯的美。',
      '媒体中心': '由鸦天狗运营的现代化新闻中心。在这里，射命丸文和姬海棠果为了抢占头条新闻而展开激烈的“文笔之战”。'
    }
  },
  {
    id: 'former-hell',
    ...
    x: 57.3, y: 91.4, 
    type: 'underground',
    description: '位于地底深处的广阔地下世界，曾是地狱的一部分。现由鬼族接管并建立了热闹的街道和温泉街。地灵殿的主人古明地觉负责管理下方的灼热地狱遗址，是地底妖怪的权力核心。',
    characters: ['古明地觉', '古明地恋', '星熊勇仪', '水桥帕露西', '火焰猫燐', '灵乌路空'],
    subLocations: ['地灵殿', '旧地狱街道', '旧地狱温泉街', '灼热地狱遗址'],
    subLocationDetails: {
      '地灵殿': '地底最宏伟的宫殿，整体风格充满了维多利亚时代的精致与压抑。宫殿主人古明地觉在此读取着每一个造访者的心声。',
      '旧地狱街道': '热闹非凡的地底商业街。在鬼族的治理下，这里充满了江湖气息，江户风格的建筑在昏暗的火光下显得格外亲切。',
      '旧地狱温泉街': '著名的地底疗养圣地。在这里，灼热地狱的余热被转化为舒适的温泉水，是妖怪们在战斗之余放松身心的最佳选择。',
      '灼热地狱遗址': '位于地底最深处的禁忌之地。滚烫的岩浆在此翻滚，为地底世界提供着源源不断的能源，由灵乌路空负责监管。'
    }
  }
]);
...
请根据以上背景信息和你的知识储备，回答用户的问题。如果问题超出了当前地点的范围，你也可以根据《东方Project》的设定进行回答，但要保持引导者的身份。`;
    ...
    chatMessages.value.push({ role: 'assistant', content: '（哎呀，好像出了一点小意外... 没法连接到博丽大结界外的思念了呢。）' });
  } finally {
              ...
              <div class="h-full bg-izakaya-paper/95 backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-izakaya-wood/20 overflow-hidden flex flex-col relative">
                ...
                <div class="relative z-0 pt-14 px-6 pb-6 flex-1 overflow-y-auto custom-scrollbar space-y-6">
                  ...
                  <div v-if="!selectedSubLocationName" class="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <!-- Header -->
                    <div>
                      <div class="text-[10px] font-bold text-touhou-red/60 uppercase tracking-widest mb-1">{{ typeMap[selectedLocation.type || ''] || '地点' }}</div>
                  ...
                  <div v-else class="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
                    <div>
                      <div class="text-[10px] font-bold text-izakaya-wood/40 uppercase tracking-widest mb-1">
                        {{ selectedLocation.name }} · {{ selectedDetailType === 'collab' ? '角色设定' : '区域说明' }}
                      </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <p class="text-sm text-izakaya-wood/80 leading-relaxed font-serif">
                        {{ (selectedDetailType === 'collab' ? selectedLocation.collabCharacterDetails : selectedLocation.subLocationDetails)?.[selectedSubLocationName!] || '暂无详细说明。' }}
                      </p>
                    </div>

                    <div class="p-4 bg-izakaya-wood/5 rounded-xl border border-izakaya-wood/10">
                      <p class="text-[10px] text-izakaya-wood/40 italic">
                        {{ selectedDetailType === 'collab' ? `这位角色常出现在 ${selectedLocation.name} 区域。` : `该区域位于 ${selectedLocation.name} 范围内。` }}
                        你可以点击左上角的“返回”查看整体介绍。
                      </p>
                    </div>
                  </div>
                    ...
                    <div class="p-4 border-b border-izakaya-wood/10 flex flex-col gap-3 bg-izakaya-wood/5">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                          ...
                          <span class="text-sm font-bold text-izakaya-wood font-display">求闻笔录</span>
                        </div>
                      ...
                      <!-- Model Selector -->
                      <div class="flex items-center gap-2">
                        <span class="text-[10px] text-izakaya-wood/40 font-bold uppercase tracking-tighter">模型配置:</span>
                        <select 
          ...
          <div class="absolute top-0 left-0 right-0 z-20 flex items-center justify-between p-6 bg-gradient-to-b from-black/60 to-transparent pointer-events-none">
            <div class="flex items-center gap-4 pointer-events-auto">
              ...
              <div class="drop-shadow-md">
                <h2 class="text-2xl font-display font-bold text-white leading-none tracking-widest">幻想乡全图</h2>
                <p class="text-xs text-white/60 font-serif mt-1 uppercase tracking-tighter">Gensokyo Map · 21:9 Cinema Scope</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-3 pointer-events-auto">
              ...
              <div class="flex items-center bg-black/40 backdrop-blur-md rounded-full border border-white/20 p-1 px-2 shadow-xl">
                <button @click="handleZoom(0.2)" class="p-2 hover:bg-white/20 rounded-full transition-colors text-white/80" title="放大">
                  <ZoomIn class="w-5 h-5" />
                </button>
                <div class="w-px h-4 bg-white/10 mx-1"></div>
                <button @click="handleZoom(-0.2)" class="p-2 hover:bg-white/20 rounded-full transition-colors text-white/80" title="缩小">
                  <ZoomOut class="w-5 h-5" />
                </button>
                <div class="w-px h-4 bg-white/10 mx-1"></div>
                <button @click="resetZoom" class="p-2 hover:bg-white/20 rounded-full transition-colors text-white/80" title="重置">
