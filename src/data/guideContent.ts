...
> [!IMPORTANT]
> **本游戏是一个本地运行的 AI 驱动项目，所有剧情与逻辑均由大语言模型 (LLM) 生成。游戏本身不提供 API 服务，您需要自备才能正常体验全流程哦。**
...
### 如何进入？
1. 点击顶部栏右侧的 **[🌐 联机中心]** 图标。
2. 或者直接点击这里：**[🌐 全能联机中心](action:openMultiplayer)**。

### 核心功能

1. **📡 实时联机同步**
    - 采用高性能 WebSocket 技术，实现多人同屏互动。您的每一个动作、每一句对话都能实时传达给伙伴。

2. **🏰 房间管理**
    - **大厅浏览**：实时查看全服公开的房间列表，了解当前活跃的幻想乡世界。
    - **快速加入**：已知伙伴的房间 ID？直接输入 ID 即可一键传送。
    - **私人房间**：支持设置房间密码。只有持有正确“密信”的伙伴才能进入您的私人领地。

3. **🔐 端到端加密 (E2EE)**
    - **绝对隐私**：所有玩家间的通信（包括聊天内容、游戏数据）均采用 **AES-GCM** 高强度加密。
    - **数据主权**：加密密钥仅在房间内的玩家间共享。即使是中继服务器也无法解密您的通信内容，确保您的物语仅属于您和伙伴。

4. **🌐 灵活的服务器选择**
    - **官方中继**：极速连接，无需配置。我们承诺官方服务器仅作为数据转发节点，**不存储任何**聊天内容或游戏数据。
    - **自定义服务器**：支持进阶玩家部署自己的中继服务器。在设置中填入您的服务器地址，彻底掌握数据链路。

### 联机建议
- **网络环境**：请确保您的网络环境稳定，以获得最佳的同步体验。
- **文明互动**：请遵守幻想乡的和谐准则，尊重每一位一同冒险的伙伴。

> **小贴士**：在联机模式下，您可以与伙伴共同面对强大的 Boss，或在经营中互相协作，体验翻倍的乐趣！
`
  },
  {
    id: 'drawing',
